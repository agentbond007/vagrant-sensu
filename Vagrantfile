...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "client3" do |client|
    client.vm.host_name = "client3"
    client.vm.network "private_network", ip: "192.168.250.103"
    client.vm.provision "shell", inline: "sudo bash"
    client.vm.provision "shell", inline: "service iptables stop"
    client.vm.provision "shell", inline: "cp -f /vagrant/client/sensu.repo /etc/yum.repos.d/"
    client.vm.provision "shell", inline: "yum install sensu -y"
    ...
    client.vm.provision "shell", inline: "ln -s /opt/sensu/embedded/bin/ruby /usr/bin/"
    client.vm.provision "shell", inline: "cp -rf /vagrant/client/sensu/* /etc/sensu/"
    client.vm.provision "shell", inline: "sed -i 's/clientname/client.3.#{domain}/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "sed -i 's/ipaddr/192.168.250.103/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "chkconfig sensu-client on"
    client.vm.provision "shell", inline: "service sensu-client start"
  end

  config.vm.define "client4" do |client|
    client.vm.host_name = "client4"
    client.vm.network "private_network", ip: "192.168.250.104"
    client.vm.provision "shell", inline: "sudo bash"
    client.vm.provision "shell", inline: "service iptables stop"
    client.vm.provision "shell", inline: "cp -f /vagrant/client/sensu.repo /etc/yum.repos.d/"
    client.vm.provision "shell", inline: "yum install sensu -y"
    ...
    client.vm.provision "shell", inline: "ln -s /opt/sensu/embedded/bin/ruby /usr/bin/"
    client.vm.provision "shell", inline: "cp -rf /vagrant/client/sensu/* /etc/sensu/"
    client.vm.provision "shell", inline: "sed -i 's/clientname/client.4.#{domain}/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "sed -i 's/ipaddr/192.168.250.104/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "chkconfig sensu-client on"
    client.vm.provision "shell", inline: "service sensu-client start"
  end

  config.vm.define "client5" do |client|
    client.vm.host_name = "client5"
    client.vm.network "private_network", ip: "192.168.250.105"
    client.vm.provision "shell", inline: "sudo bash"
    client.vm.provision "shell", inline: "service iptables stop"
    client.vm.provision "shell", inline: "cp -f /vagrant/client/sensu.repo /etc/yum.repos.d/"
    client.vm.provision "shell", inline: "yum install sensu -y"
    ...
    client.vm.provision "shell", inline: "ln -s /opt/sensu/embedded/bin/ruby /usr/bin/"
    client.vm.provision "shell", inline: "cp -rf /vagrant/client/sensu/* /etc/sensu/"
    client.vm.provision "shell", inline: "sed -i 's/clientname/client.5.#{domain}/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "sed -i 's/ipaddr/192.168.250.105/g' /etc/sensu/conf.d/client.json"
    client.vm.provision "shell", inline: "chkconfig sensu-client on"
    client.vm.provision "shell", inline: "service sensu-client start"
  end
end